                    ...
                    <>
                        ...
                        <div className="space-y-3 relative z-10"> 
                            <button 
                                ...
                                className="w-full bg-white hover:bg-slate-50 text-slate-900 font-bold py-3.5 px-4 rounded-xl transition-all shadow-lg flex items-center justify-center gap-3"
                            >
                            ...
                            {mode !== 'forgot_password' && (
                                <>
                                    <div className="relative flex items-center py-2 mt-4 mb-2">
                                        ...
                                        <span className="flex-shrink-0 mx-4 text-slate-500 text-xs font-medium uppercase tracking-wider">O</span>
                                        <div className="flex-grow border-t border-slate-800"></div>
                                    </div>
                                    <button 
                                        type="button"
