    ...
    return (
        <>
            ...
            >
                ...
                {/* OVERLAY DECORATIVO (Solo visible en contenido principal y Mobile) */}
                ...
                {viewState === 'envelope' && !isEditable && !forceViewContent ? (
                    ...
                    <div className="relative z-20 bg-stone-50 text-slate-800">
                        ...
                        {/* NEW: DRESS CODE GALLERY based on Invitation Config (Preferred) */}
                        {invitation.components_config?.dress_code?.inspiration_images && invitation.components_config.dress_code.inspiration_images.length > 0 && (
                            <div className="py-12 bg-white/50 text-center">
                                ...
                                <div className="container mx-auto px-4 flex gap-4 overflow-x-auto pb-4 snap-x justify-start md:justify-center">
                                    {(invitation.components_config.dress_code.inspiration_images).map((url: string, idx: number) => (
