                ...
                <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <div className="flex gap-4 w-full">
                        <button
                            ...
                            disabled={loading}
                            className="flex-1 bg-white hover:bg-slate-50 text-slate-900 font-bold py-3.5 rounded-xl transition-all duration-200 flex items-center justify-center gap-3"
                        >
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="flex-1 bg-[#1877F2] hover:bg-[#1865F2] text-white font-bold py-3.5 rounded-xl transition-all duration-200 flex items-center justify-center gap-3"
                        >
